...
export function CreateVersionModal({ isOpen, onClose, rfpId, supplierId, supplierName }: CreateVersionModalProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        createVersion({ supplierId, versionName, versionDate }, {
            onSuccess: () => {
