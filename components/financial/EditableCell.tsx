...
export function EditableCell({ value, onChange, isEditing, type, suffix, isModified }: EditableCellProps) {
    ...
    return (
        <div className="text-right text-xs truncate">
            {formatted} {suffix && <span className="text-[10px] text-gray-500 ml-0.5">{suffix}</span>}
        </div>
    )
}
