...
/** Personal access tokens of the signed-in user for the MCP server, in the current organisation. */
export function TokensPanel({ organizationId }: { organizationId: string }) {
  ...
  async function fetchTokens() {
    setLoading(true);
    try {
      const res = await fetch(`/api/tokens?organizationId=${organizationId}`, { credentials: "include" });
      if (res.ok) {
