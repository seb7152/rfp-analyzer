          ...
          <div className="flex flex-col h-full overflow-hidden">
            ...
            <div className="flex-1 flex flex-col min-h-0 border-b border-slate-200 dark:border-slate-800">
              ...
              >
                ...
                <TabsContent
                  value="comment"
                  className="flex-1 p-4 mt-0 data-[state=active]:flex flex-col bg-white dark:bg-slate-950 outline-none"
                >
                  <Textarea
                    value={manualComment}
                ...
                <TabsContent
                  value="ai"
                  className="flex-1 p-0 mt-0 data-[state=active]:flex flex-col bg-white dark:bg-slate-950 outline-none overflow-hidden"
                >
                  <ScrollArea className="flex-1 p-6">
